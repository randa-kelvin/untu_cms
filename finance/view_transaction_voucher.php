...
<div class="modal fade show" data-backdrop="static" id="approvedTransaction" tabindex="-1" role="dialog"
            ...
            <div class="pd-20 card-box">
                ...
                <div class="pd-20 card-box mb-30">
                    <form method="post" action="">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <input id="transactionId" value="<?= $transactionVoucher['id'] ?>"
                                               hidden="hidden">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   ...
                                                   class="form-control" name="firstApprover" id="firstApprover"
                                                   readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?= $transactionVoucher['firstApprovedAt'] ?>"
                                                   class="form-control" name="firstApprovedAt" id="firstApprovedAt"
                                                   readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   ...
                                                   class="form-control" name="secondApprover" id="secondApprover"
                                                   readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?= $transactionVoucher['secondApprovedAt'] ?>"
                                                   class="form-control" name="secondApprovedAt" id="secondApprovedAt"
                                                   readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   value="<?= $transactionVoucher['secondApprovalStatus'] ?>"
                                                   class="form-control font-weight-bold
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="">
                                                    <label for="id" hidden="hidden"></label>
                                                    <input name="id" id="id" value="<?= $transactionVoucher['id']; ?>"
                                                           hidden="hidden">
                                                    <label for="status" hidden="hidden"></label>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-6 col-md-6 col-form-label">
                                                            <button type="submit" class="btn btn-warning btn-block"
                                                                    name="secondApprove01">Revert
                                                            </button>
                                                        </div>
                                                        <div class="col-sm-6 col-md-6 col-form-label">
                                                            <button type="button" class="btn btn-secondary btn-block"
                                                                    id="cancelButton" data-dismiss="modal">Cancel
                                                            </button>
                                                        </div>
                                                    </div>
                                                </form>
                        ...
                        <div class="col-md-4 col-sm-12 mb-2">
                            <div class="height-100-p">
                                <div class="modal fade" id="HOReviseModal" tabindex="-1"
                                     aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-6 col-md-6 col-form-label">
                                                            <button type="submit" name="firstApprove01"
                                                                    class="btn btn-warning btn-block"
                                                                    id="firstApprove01">Revert
                                                            </button>
                                                        </div>
                                                        <div class="col-sm-6 col-md-6 col-form-label">
                                                            <button type="button" class="btn btn-secondary btn-block"
                        ...
                        <div class="col-md-4 col-sm-12 mb-2">
                            <div class="height-100-p">
                                <div class="modal fade" id="HODeclineModal" tabindex="-1"
                                     aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
