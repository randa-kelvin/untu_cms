                ...
                <div class="pd-20 card-box">
                    ...
                    <div class="tab">
                        <ul class="nav nav-pills" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active text-blue" data-toggle="tab" href="#campaigns" role="tab"
                                   aria-selected="true">
                                    Manage Campaigns
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-blue" data-toggle="tab" href="#zones" role="tab"
                                   aria-selected="false">
                                    Manage Zones
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-blue" data-toggle="tab" href="#cities" role="tab"
                                   aria-selected="false">
                                    Manage Cities
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-blue" data-toggle="tab" href="#sectors" role="tab"
                                   aria-selected="false">
                                    Manage Sectors
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-blue" data-toggle="tab" href="#targets" role="tab"
                                   aria-selected="false">
                                    Manage Targets
                                </a>
                            </li>
