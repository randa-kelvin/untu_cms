        ...
        <div class="row">
            <div class="col-md-3 col-sm-12">
                <div class="form-group">
                    ...
                    <input id="birthday" class="date-picker form-control" name = "dob" required="required" autocomplete="off" placeholder="DD MM YYYY"
                           value="<?php
                                        if ($user_loans[0]['dateOfBirth'] != "1970-01-01") {
                                            echo $user_loans[0]['dateOfBirth'];
                                        }
                                        ?>"
                           min="<?php $date = date("Y-m-d", strtotime("-65 years")); echo $date;?>" max="<?php $date = date("Y-m-d", strtotime("-18 years"));
                    ?>">
                </div>
            </div>
            <div class="col-md-3 col-sm-12">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12">
                <div class="form-group">
                    ...
                    <input id="businessStartDate" name="businessStartDate" autocomplete="off"
                           value="<?php
                           if ($user_loans[0]['businessStartDate'] != "1970-01-01") {
                               echo $user_loans[0]['businessStartDate'];
                           }
                           ?>"
                        min="1905-01-01" max="2022-12-31" class="date-picker form-control" placeholder="DD MM YYYY" required>
                </div>
            </div>
            <div class="col-md-4 col-sm-12">
                <div class="form-group">
