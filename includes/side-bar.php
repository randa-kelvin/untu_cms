...
<!--                        <li><a href="loan_applications.php?state=all">All Applications</a></li>-->
                ...
                <!-- Module: Purchase Order (from ROLE_FIN) -->
                <?php if ($_SESSION['poUser']['role'] != null) { ?>
                    <li class="dropdown">
                        <a href="javascript:" class="dropdown-toggle">
                            <span class="micon bi bi-cash-stack"></span><span class="mtext">Purchase Order</span>
                ...
                <!-- Module: Cash Management (from ROLE_FIN) -->
                <?php if ($_SESSION['cmsUser']['role'] != null) { ?>
                    <li class="dropdown">
                        <a href="javascript:" class="dropdown-toggle">
                            <span class="micon bi bi-cash-coin"></span><span class="mtext">Cash Management</span>
                ...
                <!-- Module: Treasury Management (from ROLE_FIN) -->
                <?php if ($_SESSION['tmsUser']['role'] != null){ ?>
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon bi bi-cash-stack"></span><span class="mtext">Treasury Management</span>
                ...
                <!-- Module: Interim Statements (from ROLE_FIN) -->
                <?php if ($_SESSION['branch'] == "Head Office") { ?>
                    <li class="dropdown">
                        <a href="javascript:" class="dropdown-toggle">
                            <span class="micon bi bi-cash-coin"></span><span class="mtext">Interim Statements</span>
...
<!--                            <li><a href="interim_statements.php?menu=reports">Calc Matured Interests</a></li>-->
                ...
                <!-- Module 1: Activity Reports -->
                <!--                <li class="dropdown">-->
                <!--                    <a href="javascript:" class="dropdown-toggle">-->
                <!--                        <span class="micon bi bi-folder"></span><span class="mtext">Activity Report(s)</span>-->
                <!--                    </a>-->
                <!--                    <ul class="submenu">-->
                ...
                <!-- Module 3: Credit Analytics -->
                <li class="dropdown">
                    <a href="javascript:" class="dropdown-toggle">
                        <span class="micon bi bi-table"></span><span class="mtext">Credit Analytics</span>
                    </a>
                    <ul class="submenu">
                        <li><a href="http://13.246.85.3:4200/credit/loan-applications/pending" target="_blank">Client Eligibility</a></li>
                    </ul>
                </li>

                <!-- Module 4: Recoveries Tracker -->
                <li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle">
                ...
                <!-- Module 5: Performing Clients -->
                <li>
                    <a href="performing_clients.php" class="dropdown-toggle no-arrow">
                        <span class="micon bi bi-calendar4-week"></span><span class="mtext">Performing Clients</span>
                    </a>
                </li>

                <!-- Module 6: Documents Manager -->
                <li class="dropdown">
                    <a href="javascript:" class="dropdown-toggle">
                        <span class="micon bi bi-textarea-resize"></span><span class="mtext">Documents Manager</span>
                    </a>
                    <ul class="submenu">
